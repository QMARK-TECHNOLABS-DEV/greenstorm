            ...
            <div class="row">
                ...
                <div class="col-lg-3 mg-t-30 mg-lg-t-0">
                    <div class="card pd-20 pd-xs-30 shadow-base bd-0 ">
                        ...
                        @foreach ($photograph_categories as $photo_category) 
                        <div class="row row-xs mg-b-15"> 
                            @foreach ($photo_category->photographs as $photo)   
                                ...
                                <div class="col">
                                    <div class="overlay">
                                        ...
                                        <div class="overlay-body bg-black-5 d-flex align-items-center justify-content-center">
                                            <span class="tx-white tx-12">Total 
                                                {{ $photo_category->photographsCount }}
                                            </span>
                                        </div> 
                                    </div> 
                                </div>
                        ...
                        <div class="d-flex alig-items-center justify-content-between"> 
                            <h6 class="tx-gray-800 tx-uppercase tx-semibold tx-14 mg-b-30">{!! $photo_category->title !!}</h6>
