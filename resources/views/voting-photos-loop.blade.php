        ...
        <a class="imagePopupTriggerButton"
           ...
           role="button">
            ...
            <div class="votes_box">
                ...
                <figure class="w-full h-[300px] m-0 p-0 overflow-hidden">
                    <img src="{{ $voting->photograph->image }}" alt="" class="w-full h-full object-cover block" />
                </figure>
                ...
                <div class="lupa text-center">
                    ...
                    @if(Auth::check())
                        @if(!$voting->photograph->userVoted(Auth::user()->id))
                            {{-- Uncomment to enable voting button --}}
                            {{--
