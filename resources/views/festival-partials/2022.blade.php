<ul class="gallery_list row mb-0 p-0">
    ...
    <!-- end -->
    <li class="col-lg-4 col-md-6 ">
        <a class="image-popup-vertical-fit" href="{{ asset('web/img/gallery/2021/TITTU-SHAJI-THOMAS.jpg') }}" title="Binz-Jos">
            <div class='box-4'>
                <figure >
                    <img src="{{ asset('web/img/gallery/2021/TITTU-SHAJI-THOMAS.jpg') }}" alt="" />
                </figure>
                <div class='lupa text-center'>
                 <p class="phto_owner_name">TITTU SHAJI THOMAS    </p>
    ...
    <!-- end -->
    <li class="col-lg-4 col-md-6 ">
        <a class="image-popup-vertical-fit" href="{{ asset('web/img/gallery/2021/Yuri-Pristik.jpg') }}" title="Binz-Jos">
            <div class='box-4'>
                <figure >
                    <img src="{{ asset('web/img/gallery/2021/Yuri-Pristik.jpg') }}" alt="" />
                </figure>
                <div class='lupa text-center'>
                 <p class="phto_owner_name">Yuri Pristik  </p>
