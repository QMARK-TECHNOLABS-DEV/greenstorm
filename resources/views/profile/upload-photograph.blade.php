                    ...
                    <form class="photographUploadForm" id="photographUploadForm" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="text-center content_box ">
                                ...
                                <p class="text-center drop_head_info mb-1">
                                    <input name="image[]" id="upload_image_background" multiple data-post-name="image_background" data-post-url="https://someplace.com/image/uploads/background/" class="position-absolute invisible" type="file" accept="image/jpeg" />
