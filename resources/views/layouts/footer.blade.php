...
<div class="footer-area   pb-0  {{ Request::segment(2) == 'upload-photograph' ? 'bg-light': '' }}">
        ...
        <div class="copyright-area ">
            <div class="row copyright-row align-items-center">
                <div class="col-lg-6 text-start wow animate__animated animate__fadeInLeft" data-wow-delay=".3s">
                    <span class="copyright-text"> © 2025 Copyright Greenstorm Foundation. All rights reserved.
                         </span>
